...
public class ActionAgent implements TestAgent {
    ...
    private String getSystemPrompt() {
        return "You are a UI Test Automation Agent. Your goal is to execute test cases EXACTLY as specified.\n" +
                ...
                "- TEXT selector: ONLY for visible text content (button labels, link text, headings, paragraphs)\n" +
                "  ❌ WRONG: {\"type\":\"TEXT\", \"value\":\"textbox\"} - 'textbox' is a role, not visible text\n" +
                "  ❌ WRONG: {\"type\":\"TEXT\", \"value\":\"button\"} - 'button' is a role, not visible text\n" +
                "  ✓ CORRECT: {\"type\":\"TEXT\", \"value\":\"Sign in\"} - 'Sign in' is actual button text\n" +
                "\n" +
                "- ROLE selector: For ARIA roles (button, textbox, link, checkbox, etc.)\n" +
                "  ✓ Use: {\"type\":\"ROLE\", \"value\":\"textbox\"} for input fields\n" +
                "  ✓ Use: {\"type\":\"ROLE\", \"value\":\"button\"} when you don't know button text\n" +
                "\n" +
                "- For INPUT FIELDS (username, password, email, etc.):\n" +
                "  1st choice: PLACEHOLDER selector (e.g., {\"type\":\"PLACEHOLDER\", \"value\":\"Enter password\"})\n" +
                "  2nd choice: LABEL selector (e.g., {\"type\":\"LABEL\", \"value\":\"Password\"})\n" +
                "  3rd choice: CSS selector (e.g., {\"type\":\"CSS\", \"value\":\"input[type='password']\"})\n" +
                "  4th choice: ROLE with meta (e.g., {\"type\":\"ROLE\", \"value\":\"textbox\", \"meta\":{\"nearText\":\"Password\"}})\n" +
                "\n" +
